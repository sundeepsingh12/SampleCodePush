...
import Aes from './Aes'; //uncomment to use in Node.js
...
class AesCtr extends Aes {
     ...
     */
    static encrypt(plaintext, password, nBits, counterBlock) {
        ...
        //const counterBlock = [1, 2, 3, 4, 5, 6, 7, 8]
...
export default AesCtr;// uncomment to use in Node.js