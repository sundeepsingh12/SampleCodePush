...
class Statistics {
    setStatisticsList(statisticsList) {
        ...
        statisticsData[id] = {
            id, value: (statisticsList.officialCallOutgoingDuration != null && statisticsList.cugCallOutgoingDuration != null) ? parseInt(statisticsList.officialCallOutgoingDuration + statisticsList.cugCallOutgoingDuration) / 60 + " minutes," +
