...
import { Sorting, SET_SORTING_BLUETOOTH_CONNECTION } from '../lib/constants';
import { Toast, StyleProvider, Container, Content, Header, Body, Button, Icon, ListItem } from 'native-base'
...
function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators({ ...bluetoothActions, ...globalActions }, dispatch)
  }
}
    ...
    BluetoothSerial.connect(device.id)
      .then(paired => {
        ...
        if (paired) {
          ...
          if (this.props.navigation.state.params.screenName && this.props.navigation.state.params.screenName == Sorting) {
            this.props.actions.setState(SET_SORTING_BLUETOOTH_CONNECTION, { isBluetoothConnected: true })
