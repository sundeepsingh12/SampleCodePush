...
class BulkListing extends PureComponent {
  ...
  _setQrValue = (value) => {
    if (value && value != '')
      this.props.actions.setSearchedItem(value, this.props.bulkTransactionList, this.props.searchSelectionOnLine1Line2, this.props.idToSeparatorMap)
  }
  searchBarView() {
    return (
          ...
          <TextInput
            ...
            onEndEditing={() => {
              if (this.props.searchText && this.props.searchText != '')
                this.props.actions.setSearchedItem(this.props.searchText, this.props.bulkTransactionList, this.props.searchSelectionOnLine1Line2, this.props.idToSeparatorMap)
            }}
