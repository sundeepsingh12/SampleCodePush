...
import { CHECK_CURRENT_PASSWORD, SET_NEW_PASSWORD, SET_CONFIRM_NEW_PASSWORD, TOGGLE_SAVE_RESET_BUTTON, CLEAR_PASSWORD_TEXTINPUT } from '../lib/constants'
...
class ResetPassword extends PureComponent {
  ...
  componentDidMount() {
    this.props.actions.setState(CLEAR_PASSWORD_TEXTINPUT)
  }
    ...
    return <Content style={[styles.flex1, styles.bgWhite]}>
      <View style={[styles.bgWhite, styles.padding10, styles.marginTop30]}>
        <Item stackedLabel style={[styles.marginBottom15]}>
          ...
          <Input secureTextEntry={true} onChangeText={this._setCurrentPassword} value={this.props.currentPassword} />
        </Item>
        <Item stackedLabel style={[styles.marginBottom15]}>
          ...
          <Input secureTextEntry={true} onChangeText={this._setNewPassword} value={this.props.newPassword} />
        </Item>
        <Item stackedLabel style={[styles.marginBottom15]}>
          <Label style={[{ color: styles.fontPrimaryColor }, styles.fontSm]}>{CONFIRM_NEW_PASSWORD}</Label>
          <Input secureTextEntry={true} onChangeText={this._setConfirmNewPassword} value={this.props.confirmNewPassword} />
        </Item>
      </View>
    </Content>
  }
