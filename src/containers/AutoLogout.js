...
import { invalidateUserSessionForAutoLogout } from '../modules/pre-loader/preloaderActions'
import {
    StyleSheet,
    View,
    Text,
...
function mapDispatchToProps(dispatch) {
    return {
        actions: bindActionCreators({ invalidateUserSessionForAutoLogout }, dispatch)
    }
}
