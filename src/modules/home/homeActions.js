...
import { Platform, Modal,ActivityIndicator,View} from 'react-native'
      ...
      new CallDetectorManager(async (event,number)=> {
        console.log('event',event)
         if (event === 'Incoming') {
           ...
           const dataObject = jobDataService.getCallerIdListAndJobId(number, callerJobAttributeData.idJobAttributeMap, callerJobAttributeData.query)
